...
const upsertSniperMode = require("../../../databases/upsertSniperMode");
const upsertSniperTarget = require("../../../databases/upsertSniperTarget");
...
module.exports = async ({ bot, msg, redis, action, chains }) => {
  ...
  if (theSnipingCache) {
    ...
    await upsertSniperMode(msg.chat.id, chains[chainused].chain_id, sniperMode);
    await upsertSniperTarget(msg.chat.id, chains[chainused].chain_id, snipingPreparation.address, targetSnipe[0]);
