...
/**
 * buyTokenUseETH(chainIdx, walletPK, tokenAddress, amount, slippage = "10000", tip, gasLimit, gasPrice, deadlineSec, redis)
 *
...
function snipeBuyTokenUseETH(
  ...
  return new Promise(async (resolve) => {
    try {
      ...
      const tokenOut = new Token(chainId, tokenAddress, tokenDecimals); // USDC
      const tokenIn = WETH[tokenOut.chainId];
      ...
      const platformFee = amountIn.mul(benefits.tradingFee * 100).div(10000);
...
module.exports = snipeBuyTokenUseETH;
